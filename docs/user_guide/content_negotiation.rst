...
+=============+=================================+====================================================================+
| HTML        | `text/html`                     | `https://data.judaicalink.org/data/html/yivo/moses-mendelssohn`_   |
| JSON-LD     | `application/ld+json`           | `https://data.judaicalink.org/data/jsonld/yivo/moses-mendelssohn`_ |
| RDF/XML     | `application/rdf+xml`           | `https://data.judaicalink.org/data/xml/yivo/moses-mendelssohn`_    |
| Turtle      | `text/turtle`                   | `https://data.judaicalink.org/data/ttl/yivo/moses-mendelssohn`_    |
+-------------+---------------------------------+--------------------------------------------------------------------+
